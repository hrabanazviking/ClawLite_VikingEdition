# CONNECTIONS clawlite/channels/telegram_transport.py
...
```mermaid
flowchart TD
    N0["telegram_transport.py"]
    R1["clawlite/channels/telegram.py"]
    R2["tests/channels/test_telegram_transport.py"]
    T1["tests/channels/test_telegram.py"]
    T2["tests/channels/test_telegram_transport.py"]
    R1 -->|uses| N0
    R2 -->|uses| N0
    T1 -->|tests| N0
    T2 -->|tests| N0
