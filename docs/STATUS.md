...
- Full suite: `python -m pytest tests/ -q --tb=short` → **1793 passed, 1 skipped**
...
```bash
python -m pytest tests/ -q --tb=short  # 1791 passed, 1 skipped
