...
def rich_flow() -> None:
    console.print("[bold #ff6b2b]🦊 ClawLite Installer v0.7.0-beta.0[/bold #ff6b2b]")
    ...
    console.print(Panel.fit("🦊 ClawLite v0.7.0-beta.0 installed!\n👉 clawlite onboard", border_style="#ff6b2b"))


def simple_flow() -> None:
    print("🦊 ClawLite Installer v0.7.0-beta.0")
    print("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
    ...
    ensure_gateway_runtime()
    print("✓")
    print("🦊 ClawLite v0.7.0-beta.0 installed!\n👉 clawlite onboard")
