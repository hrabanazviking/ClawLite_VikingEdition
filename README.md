...
- 🤖 `Automation` — cron, inbound journal replay, dead-letter replay, operator channel recovery, Telegram transport refresh, provider recovery/suppression, candidate cooldowns, supervisor signals, and self-evolution state
